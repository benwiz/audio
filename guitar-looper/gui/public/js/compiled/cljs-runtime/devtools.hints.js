...
var G__40260 = cljs.core.PersistentArrayMap.EMPTY;
var G__40261 = native_stack_trace;
var G__40262 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__40263 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__40260,G__40261,G__40262,G__40263) : cljs.stacktrace.parse_stacktrace.call(null,G__40260,G__40261,G__40262,G__40263));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40268__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40268__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40268__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e40267){var _e = e40267;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___40294 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___40294)){
var seen_errors_40295 = temp__5733__auto___40294;
if(cljs.core.truth_(seen_errors_40295.has(self))){
} else {
seen_errors_40295.add(self);

var temp__5735__auto___40296 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___40296)){
var sense_40297 = temp__5735__auto___40296;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40297)].join('');
} else {
}
}
} else {
